  ...
  return (
    <footer style={{backgroundColor: '#f5f1ed', borderTop: '2px solid #000000', color: '#000000', marginTop: '80px', padding: '60px 20px'}}>
      <div style={{maxWidth: '1200px', margin: '0 auto', marginBottom: '40px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '40px'}}>
        ...
        <div>
          <div style={{display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px'}}>
            ...
            <div>
              <h3 style={{fontSize: '20px', fontWeight: '900', color: '#000000', margin: '0'}}>Nasarumaa</h3>
              <p style={{fontSize: '11px', color: '#000000', fontWeight: 'bold', margin: '0'}}>Collection Attire</p>
            </div>
          </div>
        ...
        <div>
          ...
          <div style={{display: 'flex', gap: '12px', marginBottom: '16px', alignItems: 'flex-start'}}>
            ...
            <div>
              ...
              <a href="tel:+254711410982" style={{color: '#666666', textDecoration: 'none', fontSize: '14px', cursor: 'pointer'}} onMouseEnter={(e) => e.target.style.color = '#dc2626'} onMouseLeave={(e) => e.target.style.color = '#666666'}>+254 711 410 982</a>
            </div>
          </div>
          <div style={{display: 'flex', gap: '12px', marginBottom: '16px', alignItems: 'flex-start'}}>
          ...
          <div style={{display: 'flex', gap: '12px', alignItems: 'flex-start'}}>
            ...
            <div>
              ...
              <p style={{color: '#666666', fontSize: '14px', margin: '0'}}>Nairobi, Kenya</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{borderTop: '1px solid #cccccc', paddingTop: '40px', display: 'grid', gridTemplateColumns: '1fr auto', gap: '20px', alignItems: 'center'}}>
        <div>
          <p style={{color: '#666666', fontSize: '13px', margin: '0 0 8px 0'}}>© 2024 Nasarumaa. All rights reserved.</p>
          <p style={{color: '#666666', fontSize: '13px', margin: '0'}}>Crafted with ❤️ for authentic Maasai culture</p>
        </div>
